...
func TestRespondDownloadMiss(t *testing.T) {
	...
	t.Run("script gets 404 json", func(t *testing.T) {
		...
		respondDownloadMiss(c, "cli", "cli", release, picker.Linux, picker.AMD64, "deb", picker.LibcMusl)
	...
	t.Run("browser redirects to github html", func(t *testing.T) {
		...
		respondDownloadMiss(c, "cli", "cli", release, picker.MacOS, picker.ARM64, "", picker.LibcAny)
